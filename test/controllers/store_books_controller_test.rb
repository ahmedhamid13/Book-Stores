...
class StoreBooksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create store_book" do
    assert_difference('StoreBook.count') do
      post store_books_url, params: { store_book: { book_id: @store_book.book_id, edition: @store_book.edition, is_available: @store_book.is_available, price: @store_book.price, store_id: @store_book.store_id } }
    end
  ...
  test "should update store_book" do
    patch store_book_url(@store_book), params: { store_book: { book_id: @store_book.book_id, edition: @store_book.edition, is_available: @store_book.is_available, price: @store_book.price, store_id: @store_book.store_id } }
